...
import 'piper_tts_bindings_generated.dart';
...
const String _libName = 'piper_tts';

/// The dynamic library in which the symbols for [PiperTtsBindings] can be found.
...
final PiperTtsBindings _bindings = PiperTtsBindings(_dylib);
